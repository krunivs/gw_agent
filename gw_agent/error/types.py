...
class ErrorType(Enum):
    ...
    UNKNOWN_ERROR = \
        {'bound': 'system', 'code': '0xffff', 'text': 'unknown error'}

    # os error (unknown)
    OS_ERROR = \
        {'bound': 'system', 'code': '0xdfff', 'text': 'OS system error'}
    ...
    # runtime(unknown)
    RUNTIME_ERROR = \
        {'bound': 'in_app', 'code': '0xcfff', 'text': 'runtime error'}

    # code
    NAME_ERROR = \
        {'bound': 'in_app', 'code': '0xc001', 'text': 'undefined variable error'}
    TYPE_ERROR = \
        {'bound': 'in_app', 'code': '0xc002', 'text': 'type casting error'}
    VALUE_ERROR = \
    ...
    # file io
    EOF_ERROR = \
        {'bound': 'in_app', 'code': '0xc301', 'text': 'end of file error'}
    FILE_READ_ERROR = \
        {'bound': 'in_app', 'code': '0xc302', 'text': 'file read error'}
    YAML_IO_ERROR = \
        {'bound': 'in_app', 'code': '0xc311', 'text': 'yaml file i/o'}
    YAML_SYNTAX_ERROR = \
        {'bound': 'in_app', 'code': '0xc312', 'text': 'yaml syntax error'}

    # operation & operator
    ARITHMETIC_ERROR = \
        {'bound': 'in_app', 'code': '0xc401', 'text': 'arithmetic error'}
    ZERO_DIVISION_ERROR = \
        {'bound': 'in_app', 'code': '0xc402', 'text': 'divide by zero'}
    FP_ERROR = \
        {'bound': 'in_app', 'code': '0xc403', 'text': 'floating point error'}
    OP_OVERFLOW_ERROR = \
    ...
    HTTP_JSON_CONTENT_SYNTAX_ERROR = \
        {'bound': 'api', 'code': '0xb111', 'text': 'json content syntax error'}
